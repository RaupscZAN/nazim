        ...
        <div className="mb-12">
          <div className="bg-gradient-to-r from-burgundy-50 to-gold-50 rounded-xl p-6 md:p-8 border border-burgundy-100">
            ...
            <p className="text-slate-700 mb-4 leading-relaxed">
              Dr. Ali has founded and continues to direct major international
              conferences including the Harvard Islamic Finance Conference (29+
              years), the HBKU International Conference on Islamic Finance, and
              collaborative workshops and annual Islamic finance events with LSE
            ...
            <div className="bg-white rounded-lg p-4 border border-cream-200">
              ...
              <p className="text-slate-600 text-sm">
                Dr. Ali is available for select activities and engagements on
                topics related to Islamic finance, ethical banking, and
                information systems in financial institutions. Use the form
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="subject" className="block text-slate-700 mb-1">
                  Subject *
                </label>
                <select
                  id="subject"
              ...
              <div>
                <label htmlFor="message" className="block text-slate-700 mb-1">
                  Message *
                </label>
                <textarea
                  id="message"
