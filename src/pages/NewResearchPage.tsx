...
const researchBooks: Publication[] = [
  ...
  },
  {
    ...
    publisher: "Harvard University",
    category: "Conference",
    description: "Proceedings from the Eighth Forum, featuring cutting-edge research in Islamic finance.",
    link: "#"
  },
  {
    id: 107,
    ...
    publisher: "Harvard University",
    category: "Conference",
    description: "Comprehensive collection of papers from the Ninth Forum on Islamic Finance.",
    link: "#"
  },
  {
    id: 108,
    ...
    publisher: "Harvard University",
    category: "Conference",
    description: "Proceedings from the Tenth Forum, marking two decades of Islamic finance scholarship at Harvard.",
    link: "#"
  },
...
const ResearchPage: React.FC = () => {
  ...
  const allYears = ['All', ...new Set(researchBooks.map(book => book.year).sort((a, b) => b.localeCompare(a)))];
  
  // Filter publications based on selected year
  const filteredPublications = activeYear === 'All' 
    ? groupPublicationsByYear(researchBooks)
    : groupPublicationsByYear(researchBooks.filter(book => book.year === activeYear));
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">A collection of academic works and publications</p>
        </div>
        ...
        <div className="space-y-12">
          {filteredPublications.map(({ year, publications }) => (
            <section key={year} className="space-y-4">
              <h2 className="text-2xl font-semibold text-gray-800 border-b pb-2">{year}</h2>
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {publications.map((pub) => (
                  <div key={pub.id} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow h-full flex flex-col">
                    <div className="flex-grow">
                      ...
                      {pub.description && (
                        <p className="text-gray-700 text-sm mb-4">{pub.description}</p>
                      )}
                    </div>
